...
public interface IProductService {
   FilterProductResult findAll(List<String> categories, List<String> types, List<String> dialSizes,List<String> straps, List<String>genders, Pageable pageable, String searchText);
